...
import { FaUserTie, FaChalkboardTeacher } from "react-icons/fa"; // iconlar
      ...
      <div className="bg-white w-full max-w-md p-12 rounded-3xl shadow-[0_10px_30px_rgba(0,0,0,0.1)] flex flex-col items-center">
        ...
        <div className="flex w-full justify-around mb-6">
          <button
            ...
            className={`flex flex-col items-center p-4 w-32 rounded-2xl transition-transform transform hover:scale-105 ${
              role === "teacher"
