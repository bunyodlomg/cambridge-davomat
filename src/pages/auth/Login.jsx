                    ...
                    {!role && (
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                className="
                                    flex flex-col items-center p-6 w-36 
                                    rounded-2xl bg-white/20 hover:bg-white/30 
                    ...
                    {role === "admin" && (
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                type="submit"
                                className="
                                    w-full bg-white/30 p-3 rounded-xl text-white font-bold 
                                    border border-white/40 shadow-lg backdrop-blur-lg focus:ring-2 focus:ring-white/70 focus:outline-none
                                 "
                            >
                                Login
                            </motion.button>
